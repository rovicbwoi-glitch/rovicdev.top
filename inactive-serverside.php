...
if($user_id_2 == 1 || $user_level_2 == 'superadmin'){
    $sql = "SELECT * FROM users WHERE 1=1 AND user_id!='$user_id_2' AND device_connected='' AND (user_level='normal' OR user_level='bulk' OR user_level='trial')";
}else{
	$sql = "SELECT * FROM users WHERE 1=1 AND user_id!='$user_id_2' AND upline='$user_id_2' AND device_connected='' AND (user_level='normal' OR user_level='bulk' OR user_level='trial')";
}
